...
The `/agents/suggest-fields` endpoint analyzes a document and suggests appropriate fields for extraction based on the document content.
...
<ResponseField name="template" type="array">
  ...
  <Expandable title="Template field structure">
    ...
    <ResponseField name="value" type="any">
      The extracted value (null in the suggest-fields response).
    </ResponseField>
  </Expandable>
</ResponseField>
